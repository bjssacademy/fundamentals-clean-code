...
Global variables have the disadvantage that any piece of code, anywhere in the codebase can read and modify those variables. That means you don't have to think about which pieces of code can access them. They all can.
